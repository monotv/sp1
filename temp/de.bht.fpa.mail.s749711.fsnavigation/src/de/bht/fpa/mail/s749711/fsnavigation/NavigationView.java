...
import de.bht.fpa.mail.s749711.fsnavigation.listeners.DirectorySelectionChangedListener;
...
public class NavigationView extends ViewPart implements Observer {
  ...
  public void createPartControl(Composite parent) {
    ...
    // events
    viewer.addSelectionChangedListener(new DirectorySelectionChangedListener());
  }
  ...
  private Object createModel() {
    ...
    Config.getInstance().setFileFilter("directory");
    Config.getInstance().setExtensionFilter("xml");
